...
{$('#wb_indexShape3').addClass('visibility-hidden');$("a[href*='#header-mixa']").click(function(event)
{event.preventDefault();$('html, body').stop().animate({scrollTop:$('#wb_header-mixa').offset().top},600,'easeOutCirc');});function skrollrInit()
