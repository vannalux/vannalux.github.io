...
New_Project.stage = [{            
            ...
            // SCENE 1
            'Oid': 'X6662b07_79b28848157db078ce60ea26997260d2',
            'Name': 'SCENE_1',
            'Autostart': 'true',
  ...
  'NextSceneTransition': 'instant',                 // instant, slide, fade
                              ...
                              'OnAnimationFinishedParam': 'X6662b0f_79b28848157db078ce60ea26997260d2',
                            ...
                            'Timelines': [
            {
                ...
                {
                    'Oid': 'X6662b09_79b28848157db078ce60ea26997260d2',                
                    'Type': 'box',
                    'InnerHTML': ''
                    ,
                    'Tag': 'div',
                    ...
                    'Height': '189px',
                    'Width': '336px',
                    'ZIndex': '1','BackgroundImage': '' + x5engine.settings.currentPath + 'imObjectAnimation_37/cvf1.jpg','BackgroundSize': '100% 100%','Display': 'block','TextAlign': 'left',
...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    'Oid': 'X6662b0a_79b28848157db078ce60ea26997260d2',                
                    'Type': 'box',
                    'InnerHTML': ''
                    ,
                    'Tag': 'div',
...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    'Oid': 'X6662b0c_79b28848157db078ce60ea26997260d2',                
                    'Type': 'box',
...
'Pressed': [],
                ...
                'Transitions': [
                    ...
                    {
                            'ObjectId':'X6662b0a_79b28848157db078ce60ea26997260d2',
                            'StartTime':100,
                            'TransitionElements':[
                        {
...
{
                            'ObjectId':'X6662b0c_79b28848157db078ce60ea26997260d2',
                            'StartTime':100,
                            'TransitionElements':[
                        {
                            'Oid':'TRANSITION_BLOCK_1',
...
{            
            ...
            // SCENE 2
            'Oid': 'X6662b0f_79b28848157db078ce60ea26997260d2',
            'Name': 'SCENE_2',
            'Autostart': 'true',
            'BackgroundColor': '#ffffff',
            'SceneEnd': 4000,
  ...
  'NextSceneTransition': 'instant',                 // instant, slide, fade
                                'NextSceneTransitionDirection': '',   // only active with slide transition => left, right, up, down
                                'NextSceneTransitionSpeed': '0','OnAnimationFinished': 2,
                              'OnAnimationFinishedParam': 'X6662b17_79b28848157db078ce60ea26997260d2',
                            ...
                            'Timelines': [
            {
                ...
                {
                    'Oid': 'X6662b11_79b28848157db078ce60ea26997260d2',                
                    'Type': 'box',
                    'InnerHTML': ''
                    ,
                    'Tag': 'div',
                    ...
                    'Height': '252px',
                    'Width': '336px',
                    'ZIndex': '4','BackgroundImage': '' + x5engine.settings.currentPath + 'imObjectAnimation_37/cvf2.jpg','BackgroundSize': '100% 100%','Display': 'block','TextAlign': 'left',
...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    'Oid': 'X6662b12_79b28848157db078ce60ea26997260d2',                
                    'Type': 'box',
                    'InnerHTML': ''
                    ,
                    'Tag': 'div',
...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    'Oid': 'X6662b14_79b28848157db078ce60ea26997260d2',                
                    'Type': 'box',
                    'InnerHTML': '  <div style=\"width:100%; text-align:center; display: table; height: 100%; #position: relative; overflow: hidden;\">      <div style=\"#position: absolute; #top: 50%; display: table-cell; vertical-align: middle;\">        <div style=\"#position: relative; #top: -50%;\">          Text        </div>      </div>    </div>'
                    ,
                    'Tag': 'div',
...
'Pressed': [],
                ...
                'Transitions': [
                    ...
                    {
                            'ObjectId':'X6662b12_79b28848157db078ce60ea26997260d2',
                            'StartTime':100,
                            'TransitionElements':[
                        {
                            'Oid':'TRANSITION_BLOCK_1',
...
{
                            'ObjectId':'X6662b14_79b28848157db078ce60ea26997260d2',
                            'StartTime':100,
                            'TransitionElements':[
                        {
                            'Oid':'TRANSITION_BLOCK_1',
...
{            
            ...
            // SCENE 3
            'Oid': 'X6662b17_79b28848157db078ce60ea26997260d2',
            'Name': 'SCENE_3',
            'Autostart': 'true',
            'BackgroundColor': '#ffffff',
            'SceneEnd': 4000,
  ...
  'NextSceneTransition': 'instant',                 // instant, slide, fade
                                'NextSceneTransitionDirection': '',   // only active with slide transition => left, right, up, down
                                'NextSceneTransitionSpeed': '0','OnAnimationFinished': 2,
                              'OnAnimationFinishedParam': 'X6662b1f_79b28848157db078ce60ea26997260d2',
                            ...
                            'Timelines': [
            {
                ...
                {
                    'Oid': 'X6662b19_79b28848157db078ce60ea26997260d2',                
                    'Type': 'box',
                    'InnerHTML': ''
                    ,
                    'Tag': 'div',
                    ...
                    'Height': '226px',
                    'Width': '336px',
                    'ZIndex': '7','BackgroundImage': '' + x5engine.settings.currentPath + 'imObjectAnimation_37/cvf3.jpg','BackgroundSize': '100% 100%','Display': 'block','TextAlign': 'left',
...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    'Oid': 'X6662b1a_79b28848157db078ce60ea26997260d2',                
                    'Type': 'box',
                    'InnerHTML': ''
                    ,
                    'Tag': 'div',
...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    'Oid': 'X6662b1c_79b28848157db078ce60ea26997260d2',                
                    'Type': 'box',
                    'InnerHTML': '  <div style=\"width:100%; text-align:center; display: table; height: 100%; #position: relative; overflow: hidden;\">      <div style=\"#position: absolute; #top: 50%; display: table-cell; vertical-align: middle;\">        <div style=\"#position: relative; #top: -50%;\">          Text        </div>      </div>    </div>'
                    ,
                    'Tag': 'div',
...
'Pressed': [],
                ...
                'Transitions': [
                    ...
                    {
                            'ObjectId':'X6662b1a_79b28848157db078ce60ea26997260d2',
                            'StartTime':100,
                            'TransitionElements':[
                        {
                            'Oid':'TRANSITION_BLOCK_1',
...
{
                            'ObjectId':'X6662b1c_79b28848157db078ce60ea26997260d2',
                            'StartTime':100,
                            'TransitionElements':[
                        {
                            'Oid':'TRANSITION_BLOCK_1',
...
{            
            ...
            // SCENE 4
            'Oid': 'X6662b1f_79b28848157db078ce60ea26997260d2',
            'Name': 'SCENE_4',
            'Autostart': 'true',
            'BackgroundColor': '#ffffff',
            'SceneEnd': 4000,
  ...
  'NextSceneTransition': 'instant',                 // instant, slide, fade
                                'NextSceneTransitionDirection': '',   // only active with slide transition => left, right, up, down
                                'NextSceneTransitionSpeed': '0','OnAnimationFinished': 2,
                              'OnAnimationFinishedParam': 'X6662b07_79b28848157db078ce60ea26997260d2',
                            ...
                            'Timelines': [
            {
                ...
                {
                    'Oid': 'X6662b21_79b28848157db078ce60ea26997260d2',                
                    'Type': 'box',
                    'InnerHTML': ''
                    ,
                    'Tag': 'div',
                    ...
                    'Height': '252px',
                    'Width': '336px',
                    'ZIndex': '10','BackgroundImage': '' + x5engine.settings.currentPath + 'imObjectAnimation_37/cvf4.jpg','BackgroundSize': '100% 100%','Display': 'block','TextAlign': 'left',
...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    'Oid': 'X6662b22_79b28848157db078ce60ea26997260d2',                
                    'Type': 'box',
                    'InnerHTML': ''
                    ,
                    'Tag': 'div',
...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    'Oid': 'X6662b24_79b28848157db078ce60ea26997260d2',                
                    'Type': 'box',
                    'InnerHTML': '  <div style=\"width:100%; text-align:center; display: table; height: 100%; #position: relative; overflow: hidden;\">      <div style=\"#position: absolute; #top: 50%; display: table-cell; vertical-align: middle;\">        <div style=\"#position: relative; #top: -50%;\">          Text        </div>      </div>    </div>'
                    ,
                    'Tag': 'div',
...
'Pressed': [],
                ...
                'Transitions': [
                    ...
                    {
                            'ObjectId':'X6662b22_79b28848157db078ce60ea26997260d2',
                            'StartTime':100,
                            'TransitionElements':[
                        {
                            'Oid':'TRANSITION_BLOCK_1',
...
{
                            'ObjectId':'X6662b24_79b28848157db078ce60ea26997260d2',
                            'StartTime':100,
                            'TransitionElements':[
                        {
                            'Oid':'TRANSITION_BLOCK_1',
...
},
{
            ...
            New_Project.stageInitialScene = 'X6662b07_79b28848157db078ce60ea26997260d2';
            New_Project.debug = false;
            New_Project.preloadImages = true;
New_Project.imagesToPreload = [
'' + x5engine.settings.currentPath + 'imObjectAnimation_37/cvf1.jpg',
