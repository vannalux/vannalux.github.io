...
<html prefix="og: http://ogp.me/ns#" lang="ru-RU" dir="ltr">
	<head>
		<title><?php echo $blog->pageTitle('Блог о самом интересном - Moy', ' - '); ?></title>
		<meta charset="utf-8" />
...
<?php if (isset($data['id'])) { echo $blog->getOpengraphTags($data['id'], "\t\t"); } ?>
		...
		<link rel="stylesheet" href="../blog/style.css?2019-3-14-0-637175772678561193" media="screen,print" />
		...
		<link rel="icon" href="../favicon.png?2019-3-14-0-637175772678357676" type="image/png" />
	...
	<body>
		<div id="imPageExtContainer">
			<div id="imPageIntContainer">
				...
				<div id="imPage">
					<header id="imHeader">
						<h1 class="imHidden">Блог о самом интересном - Moy</h1>
...
?>
       ...
       <script>
                blogwidget_imSideBar_pluginAppObj_02();
					...
					<main id="imContent">
						<a id="imGoToCont"></a>
						<div id="imBlogPage" class="<?php echo (isset($data['id']) ? 'imBlogArticle' : 'imBlogHome'); ?>"><<?php echo (isset($data['id']) ? 'article' : 'div'); ?> id="imBlogContent" itemscope itemType="http://schema.org/BlogPosting"><?php
						...
						<script>
							x5engine.boot.push(function () { 
								x5engine.blogSidebarScroll({ enabledBreakpoints: ['10dfba31a11829c457bad9cff3c2daf1', 'd2f9bff7f63c0d6b7c7d55510409c19b', '72e5146e7d399bc2f8a12127e43469f1'] });
