...
<?php if (isset($_GET['id'])) { echo $blog->getOpengraphTags($_GET['id'], "\t\t"); } ?>
		...
		<link rel="stylesheet" type="text/css" href="../blog/style.css?13-1-5-16-636392631017298581" media="screen,print" />
	...
	<body>
		...
		<div id="imPage">
			...
			<div id="imContentContainer">
				...
				<div id="imContent">
					<a id="imGoToCont"></a>
				<div id="imBlogPage"><div id="imBlogContent" itemscope itemType="http://schema.org/BlogPosting"><?php
